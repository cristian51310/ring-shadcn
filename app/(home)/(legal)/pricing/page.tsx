...
export default function PagePricing() {
  return (
    ...
    <GlowCapture className="flex justify-center items-center">
      <main className="max-w-[95%] md:max-w-[90%] lg:max-w-[80%] px-3 py-8 md:py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-5 md:gap-10">
          <Glow color='purple' className="glow-capture" debug={false} style={{}}>
            <div className='flex flex-col justify-between gap-8 text-zinc-900 dark:text-white  p-8 rounded-xl border-4 border-emerald-600 md:border-zinc-400/50 md:dark:border-zinc-600 glow:border-emerald-600 bg-zinc-100 dark:bg-zinc-900 antialiased'>
              <div>
          ...
          <Glow color='purple' className="glow-capture" debug={false} style={{}}>
            <div className='flex flex-col justify-between gap-8 text-zinc-900 dark:text-white p-8 rounded-xl border-4 border-purple-600 md:border-zinc-400/50 md:dark:border-zinc-600 glow:border-purple-600 bg-zinc-100 dark:bg-zinc-900'>
              <div>
          ...
          <Glow color='purple' className="glow-capture" debug={false} style={{}}>
            <div className='flex flex-col justify-between gap-8 text-zinc-900 dark:text-white p-8 rounded-xl border-4 border-red-600 md:border-zinc-400/50 md:dark:border-zinc-600 glow:border-red-600 bg-zinc-100 dark:bg-zinc-900'>
              <div>
